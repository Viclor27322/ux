...
export function CSPMetaTag() {
  useEffect(() => {
    ...
    meta.content = `
      default-src 'self';
      script-src 'self' https://apis.google.com https://www.gstatic.com https://www.google.com https://cdn.jsdelivr.net https://js.stripe.com;
      ...
      connect-src 'self' https://www.google-analytics.com https://rest-api2-three.vercel.app https://newapiimagenes.onrender.com https://api.stripe.com;
