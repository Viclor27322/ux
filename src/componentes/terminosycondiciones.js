...
export default function Terminoss(){
    return(
        <div className="container p-5">
            <h3 className="">TERMINOS Y CONDICIONES</h3>
            <p>
        Este sitio web es operado por CirupieD. En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a CirupieD con nombre comercial ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.
      </p>
      ...
      <p>
        Los títulos utilizados en este acuerdo se incluyen solo por conveniencia y no limitan o afectan a estos Términos.
      </p>
      ...
      <ul>
        <li>La apelación de la devolución es considerada por el equipo y será tratada.</li>
        <li>Las citas deben ser canceladas con anticipación de acuerdo a los horarios.</li>
        <li>La devolución se aplica en horarios de atención.</li>
        <li>La atención brindada por el doctor es insatisfactoria y no cumple con los servicios.</li>
      </ul>
      <p>
        Si deseas hacer la devolución de alguno de nuestros productos, lo puedes hacer de las siguientes maneras:
      </p>
      <ul>
        <li>La atención médica e información se trata de manera personal en la asistencia clínica.</li>
        <li>La información solicitada se utilizará para tratamientos posteriores del paciente.</li>
        <li>El paciente acepta el uso de la información para la elaboración de estadísticas personales para su diagnóstico.</li>
        <li>Los pacientes deben contemplar cada una de las actividades que se realizan en los tratamientos.</li>
        <li>Los horarios de atención se brindan solo en horarios de atención.</li>
        <li>Solicitar la devolución dentro del plazo de devolución por correo electrónico.</li>
      </ul>

      <h5>Procedimiento</h5>
      <ol>
        <li>Devolución del dinero (solo aplica para casos de garantía y ley de retracto):
          <ul>
            <li>A través de transferencia (cuenta de ahorros, cuenta corriente, ahorro a la mano): se realiza aproximadamente dentro de los cinco días hábiles siguientes de haber realizado la apelación.</li>
            <li>A través de reversión del pago: quince días hábiles después de haber realizado la apelación. Esta reversión corre por cuenta y orden de tu entidad bancaria, cualquier duda debes comunicarte directamente con ellos.</li>
          </ul>
        </li>
        <li>Reasignación de citas dentro de los siguientes plazos.</li>
        <li>Cupón para realizar una nueva cita (Este cupón tiene validez por un mes a partir de la fecha de creación).</li>
      </ol>

      <p>Reembolso del dinero: Dependiendo del medio de pago que hayas utilizado para tu compra, el reembolso se hará a través de una transferencia electrónica o a tu tarjeta de crédito. Los reembolsos parciales se procesarán por medio de transferencia electrónica.</p>
      ...
      <p>
        Preguntas acerca de los Términos de Servicio deben ser enviadas a 20210704@uthh.edu.mx.
      </p>

      <p>Última actualización de este documento de términos y condiciones: 16/11/2023</p>
